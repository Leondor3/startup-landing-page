export function Newsletter() {
  return (
    <div className="bg-[#0f1849] flex items-center rounded-md z-20 p-8 relative">
      <div className="flex flex-col w-[350px] ">
        <h1 className="text-white font-bold text-2xl mb-4">
          Subscribe to receive future updates
        </h1>
        <p className="text-body-color text-base font-semibold mb-8">
          Lorem ipsum dolor sited Sed ullam corper consectur adipiscing Mae
          ornare massa quis lectus.
        </p>
        <hr className="border border-body-color/20" />
        <form className="w-full flex flex-col gap-4 mt-8">
          <fieldset>
            <input
              className="bg-[#242b51] w-full p-4 rounded-md border border-body-color/20 outline-none focus:none"
          ...
          <button className="bg-primary font-bold text-white text-base p-3 rounded-md">
            Subscribe
          </button>
          <span className="text-center text-body-color">
