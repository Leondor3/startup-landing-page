  ...
  return (
    <div className="relative z-10 overflow-hidden pt-[120px] pb-16 md:pt-[150px] md:pb-[120px] xl:pt-[180px] xl:pb-[160px] 2xl:pt-[210px] 2xl:pb-[200px]">
      <div className="container">
        <div className="h-full flex items-center justify-start flex-col text-center max-w-[800px] mx-auto space-y-4">
          {" "}
          <h1 className="text-5xl text-white font-bold leading-tight">
            Free and Open-Source Next.js Template for Startup & SaaS
          </h1>
          <p className="mb-12 text-base font-medium !leading-relaxed text-white dark:text-white sm:text-lg md:text-xl">
          ...
          <div className="flex gap-2 pt-8">
            <button className="bg-primary text-white font-bold px-8 py-4 rounded-md">
              Download Now
            </button>
            <button className="bg-white/20 text-white font-bold px-8 py-4 rounded-md">
              Star on Github
            </button>
          </div>
        </div>
